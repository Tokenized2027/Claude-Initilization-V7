...
description: Fixes common build and compilation errors including missing dependencies, syntax errors, webpack config issues, and module resolution. Use when user sees "build failed", "compilation error", "Module not found", "Cannot find module", "webpack error", or build-related error messages.
metadata:
