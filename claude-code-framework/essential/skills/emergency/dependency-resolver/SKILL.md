...
description: Resolves npm, yarn, or pnpm dependency conflicts including peer dependency warnings, version mismatches, and lock file corruption. Use when user sees "dependency conflict", "peer dependency", "ERESOLVE", "version mismatch", or package manager errors.
metadata:
